                ...
                <table id="ec_table" class="tableRegion" width="98%">
                    ...
                    <c:forEach items="${dataList}" var="o" varStatus="status">
                        <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                            ...
                            <td><a href="toview.action?id=${o.id}">${o.categoryName}</a></td>
                            <td>${o.categoryRemark}</td>
                            <td>
                                <c:if test="${o.categoryState==1}"><a href="stop.action?id=${o.id}"><font color="green">启用</font></a></c:if>
                                <c:if test="${o.categoryState==0}"><a href="start.action?id=${o.id}">停用</a></c:if>
                            </td>
                        </tr>
                    </c:forEach>
