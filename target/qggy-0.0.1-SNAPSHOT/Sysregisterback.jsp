...
<form name=loading>
    ...
    <p align=center>
        <font color="#0066ff">您不是青果管理员正在跳转注册页面，请稍等，注册成功等待系统管理员确认</font><font color="#0066ff"
                                                                             face="Arial">...</font> <input type=text
                                                                                                            name=chart
                                                                                                            size=46
        ...
        <script>
            ...
            function count() {
                ...
                if (bar < 99) {
                    ...
                    window.location = "${pageContext.request.contextPath}/phone/sys/basicinfo/sysuser/tocreate.action";
                }
...
<p align="center">
    如果您的浏览器不支持跳转,<a style="text-decoration: none"
                    href="${pageContext.request.contextPath}/phone/sys/basicinfo/sysuser/tocreate.action"><font
        color="#FF0000">请点这里</font></a>.
</p>
