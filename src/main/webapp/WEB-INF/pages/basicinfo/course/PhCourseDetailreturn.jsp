...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            $('#zc')
                .click(
                    function (event) {
                        window.location.href = "${pageContext.request.contextPath}/phone/user/basicinfo/class/returncourse.action?id="
                            + ${tradedetailid}
                        ;
                    });
    ...
    <!--
    <link rel="shortcut icon" type="image/x-icon" href="/images/icon/common/favicon22c41b.ico">-->
    <link rel="shortcut icon" type="image/x-icon" href="/images/girl2.ico">
            ...
            <div id="img-content">
                ...
                <div class="rich_media_content " id="js_content">
                    ...
                    <p style="text-align: center;">
                        <input id="zc" type="buttom" readonly="readonly"
                               style="width: 100%;height: 2.5rem;font-size: 1.5rem;color: #fff;background: none;background-color: #B91C22;letter-spacing: 0.2rem; text-align: center;border-radius: 0.2rem;"
                               value="确认退课"/>
                    </p>
                    <p
                    ...
                    <p
							...
							<span
                                    ...
                                    style="width:auto; border-box ! important; word-wrap: break-word ! important; visibility: visible ! important; width: auto ! important; height: auto ! important;"
                                    data-w="258" data-type="jpeg"
                                    data-src="/qggy/images/gzh.jpg?wx_fmt=jpeg" data-s="300,640"
                                    data-ratio="1" class="" src="/qggy/images/gzh.jpg" data-fail="0">
							</span>
                    </p>
                </div>
            </div>
