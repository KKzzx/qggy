                ...
                <table id="ec_table" class="tableRegion" width="98%">
                    ...
                    <c:forEach items="${dataList}" var="o" varStatus="status">
                        <tr class="odd" onmouseover="this.className='highlight'"
                            ...
                            <td><input type="checkbox" name="id" value="${o.userOpenid}"/></td>
                            ...
                            <td>${o.xianjin}</td>
                            <td><c:if test="${o.state==0}">待分部审核
                                <font color="green"><a
                                        href="shenhe.action?id=${o.userOpenid}&state=2">[提交总部审核]</a>
                                </font>
                            </c:if> <c:if test="${o.state==2}">待总部审核
                            </c:if> <c:if test="${o.state==3}">总部审核通过
                                <a href="toaddCourse.action?id=${o.id}"><font
                                        color="green">[添加课程]</font>
                                </a>
                            </c:if>
                            </td>
