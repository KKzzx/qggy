        ...
        <div>
            ...
            <div class="eXtremeTable">
                <table id="ec_table" class="tableRegion" width="98%">
                    <thead>
                    <tr>
                        <td class="tableHeader"><input type="checkbox" name="selid"></td>
                            ...
                            <c:if test="${o.adstate!=0&&o.adstate!=1}">
                                <c:if test="${o.adcategory==1}">
                                    ...
                                    <td><input type="checkbox" name="id"
                                               value="${o.advertiseId}"/></td>
                                    <td>${status.index+1}</td>
                                    <td>外部广告</td>
                                    <td><img
                                            src="${pageContext.request.contextPath}/${o.advertiseCover}"
                                    ...
                                    <td><c:if test="${o.adstate==2}">
                                        <a href="upstate.action?id=${o.advertiseId}&state=3">[发布]</a>
                                    </c:if></td>
                                </c:if>
                                <c:if test="${o.adcategory==0}">
                                    ...
                                    <td><img
                                            ...
                                            style="width: 120px; height: 80px"/></td>
                                    <td><a
                                            href="${pageContext.request.contextPath}/phone/public/basicinfo/course/phonecoursedetail.action?id=${o.advertiseUrl}">${pageContext.request.contextPath}/phone/public/basicinfo/course/phonecoursedetail.action?id=${o.advertiseUrl}</a>
                                    </td>
                                    <td><c:if test="${o.isMain==1}">
                                        <font color="green"><a
                                                href="toupisMain.action?id=${o.advertiseId}&isMain=0">显示</a></font>
                                    </c:if> <c:if test="${o.isMain==0}">
                                        <a href="toupisMain.action?id=${o.advertiseId}&isMain=1">不显示</a>
                                    </c:if></td>
                                    <td>${o.content}</td>
                                    <td>${o.areaName}</td>
                                    <td><c:if test="${o.adstate==0}">
