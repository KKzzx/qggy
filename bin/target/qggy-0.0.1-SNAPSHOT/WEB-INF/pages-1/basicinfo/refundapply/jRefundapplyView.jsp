    ...
    <div class="textbox" id="centerTextbox">
        ...
        <div>
            <div>
                ...
                <table class="commonTable" cellspacing="1">
                    <tr>
                        <td class="columnTitle">申请人：</td>
                        <td class="tableContent">${o.refundUserName}</td>
                        <td class="columnTitle">申请时间：</td>
                        <td class="tableContentAuto"><fmt:formatDate
                                value="${o.applyTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="columnTitle">申请退款金额：</td>
                        <td class="tableContent">${o.money}</td>
                    </tr>
                    <tr>
                        <td class="columnTitle">申请退款原因：</td>
                        <td class="tableContent">${o.refundReason}</td>
                    </tr>
                </table>
            </div>
        </div>
