                        ...
                        <tr class="odd" onmouseover="this.className='highlight'"
                            ...
                            <c:if test="${o.adcategory==1}">
                                ...
                                <td><c:if test="${o.isMain==1}">
                                    <font color="green"><a href="toupisMain.action?id=${o.advertiseId}&isMain=0">显示</a></font>
                                </c:if> <c:if test="${o.isMain==0}"><a
                                        href="toupisMain.action?id=${o.advertiseId}&isMain=1">不显示</a>
                                </c:if></td>
                                <td>${o.content}</td>
                                ...
                                <td><c:if test="${o.adstate==0}"><a href="upstate.action?id=${o.advertiseId}&state=1">[提交分部审核]</a></c:if>
                                    <c:if test="${o.adstate==3}"><a href="toaddcourse.action?id=${o.advertiseId}"><font
                                            color="green">[添加课程]</font></a><a
                                            href="upstate.action?id=${o.advertiseId}&state=4"><font
                                            color="green">[停用]</font></a></c:if></td>
                            </c:if>
