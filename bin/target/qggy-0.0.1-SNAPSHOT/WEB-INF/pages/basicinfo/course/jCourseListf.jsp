            ...
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        ...
                        <li id="view"><a href="#"
                                         onclick="formSubmit('listall.action','_self');this.blur();">所有</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <c:forEach items="${dataList}" var="o" varStatus="status">
                        <tr class="odd" onmouseover="this.className='highlight'"
                            ...
                            <c:if test="${o.state!=0}">
                                ...
                                <td><a
                                        href="${pageContext.request.contextPath}/phone/public/basicinfo/course/phonecoursedetail.action?id=${o.id}">${o.courseName}</a>
                                </td>
                                ...
                                <td><c:if test="${o.state==1}">
                                    <a href="upstate.action?id=${o.id}&state=2"><font
                                            color="green">[提交总部审核]</font>
                                    </a>
                                </c:if>
                                </td>
                            </c:if>
