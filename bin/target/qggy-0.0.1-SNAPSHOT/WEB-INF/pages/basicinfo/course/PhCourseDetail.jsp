            ...
            <div id="img-content">
                ...
                <div class="rich_media_content " id="js_content">
                    ...
                    <p style="text-align: center;">
                        <input id="zc" type="buttom"
                               style="width: 100%;height: 2.5rem;color: #fff;background: none;background-color: #B91C22;letter-spacing: 0.2rem; text-align: center;border-radius: 0.2rem;font-size: 1.5rem;"
                               value="立即报名" readonly/>
                    </p>
                    <p
							...
							<span
                                    ...
                                    style="line-height: inherit;vertical-align: baseline;word-break: break-all;color: rgb(255, 104, 39);max-width: 100% !important;">注：请您认真阅读青果公益《学员守则》，点击报名等同于您已阅读认可并服从青果公益相关条款！
请自查核对信息，一经开班，不退不换！
                    ...
                    <p
							...
							<span
                                    ...
                                    data-src="/qggy/images/gzh3.jpg?wx_fmt=jpeg" data-s="300,640"
                                    data-ratio="1" _width="auto" class="" src="/qggy/images/gzh3.jpg"
                                    data-fail="0"> </span>
                    </p>
                </div>
            </div>
