...
<form method="post">
    ...
    <input type="hidden" id="refundUserId" name="refundUserId"
           value="${obj.payUserId}"> <input type="hidden"
                                            readonly="readonly" name="refundUserName" value="${obj.payUserName}"/><input
        type="hidden" id="refundUserOpenid" name="refundUserOpenid"
        value="${obj.payUserOpenid}"> <input type="hidden"
                                             readonly="readonly" name="money" value="${obj.cashFee}"/>
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <li id="save"><a href="#"
                                         onclick="formSubmit('insertapply.action','_self');">确定</a></li>
    ...
    <div class="textbox" id="centerTextbox">
        ...
        <div class="textbox-header">
            <div class="textbox-inner-header">
                <div class="textbox-title">申请退款</div>
            </div>
        </div>
        <div>
            <div>
        ...
        <table>
            <tr>
                ...
                <td class="tableContent"><textarea maxlength="300"
                                                   name="refundReason" style="height:120px;"></textarea></td>
            </tr>
        </table>
</form>
</body>
