    ...
    <form id="form"
        ...
        <p>
            <input type="text" name="phoneNumber" id="phoneNumber"
                   placeholder="请输入手机号码（登录用户名）" maxlength="11" required="required"/>
        </p>
        <p>
            <input type="text" name="name" id="name" placeholder="请输入您的姓名"
                   maxlength="20" required="required" value="10"/>
        </p>
        <p>
        ...
        <p>
            <input type="password" name="password" id="password"
                   placeholder="密码" maxlength="50" required="required"/>
        </p>
        <p>
            <input type="password" name="password1" id="password1"
                   placeholder="重复密码" maxlength="50" required="required"/>
        </p>
        <p>
        ...
        <input type="checkbox" name="checkbox" id="checkbox" value=""/> <span>我已经认真阅读并同意
				<b><a
                        href="${pageContext.request.contextPath}/basicinfo/sysuser/agreement.action">《青果巷子网站使用协议》</a>
			</b> </span> <input id="zc" type="buttom" value="注册" readonly/>
    </form>
</div>
</body>
</html>
