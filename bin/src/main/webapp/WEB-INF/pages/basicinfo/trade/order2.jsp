...
<div class="my-from" style="width: 100%; height: 100%">
    ...
    <div class="my-user-message">
        <div class="my-input"
             style="font-size: 30px; height: 100px; margin-top: 20px">
            <label style="width: 20%">购买数量:</label> <input id="buy-num"
                                                           placeholder="件" name="commodity_quantity" value="1"
                                                           type="text">
            <span class="tiperror" style="color: red"></span>
        </div>
        ...
        <div class="my-input clearfix">
            ...
            <textarea name="message" id="leave-message"
