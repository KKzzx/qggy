    ...
    <form id="form"
        ...
        <p>
            <input type="text" name="phoneNumber" id="phoneNumber"
                   placeholder="请输入手机号码（登录用户名，必填）" maxlength="11" required="required" style="width: 95%;"/><font
                color="red">*</font>
        </p>
        <p>
            <input type="text" name="userName" id="userName"
                   placeholder="请输入您的真实姓名（必填）" maxlength="20" required="required" style="width: 95%;"/><font
                color="red">*</font>
        </p>
        <p>
        ...
        <p>
            <label for="">申请者自述（必填）</label><br/> <input type="hidden" name="zishu"
                                                        id="zishu"/>
            <textarea name="zishus" id="zishus" onchange="crchange()" wrap="soft" cols="5"
        ...
        <p>
            <input type="checkbox" name="checkbox" id="checkbox" value=""/> <span>我已经认真阅读并同意
					<b><a
                            href="${pageContext.request.contextPath}/phone/public/basicinfo/student/agreement.action">《青果巷子公益导师协议》</a>
				</b> </span>
        </p>
