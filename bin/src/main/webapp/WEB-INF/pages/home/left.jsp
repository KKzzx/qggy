            ...
            <div class="panel-content">
                <ul>
                    ...
                    <li><a href="${ctx}/main.action" target="main" id="aa_3"
                           onclick="linkHighlighted(this)">我的留言板</a>
                    </li>


                    <li><a href="#" onclick="linkHighlighted(this)" id="aa_2">系统使用反馈</a>
                    </li>
                    <li><a href="${ctx}/basicinfo/sysuser/changepassword.action"
                           target="main" id="aa_1" onclick="linkHighlighted(this)" id="aa_2">修改个人密码</a>
                    </li>

                    <li><a href="${ctx}/homeurl.action"
                           onclick="linkHighlighted(this)" target="main" id="aa_4">注册网址</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="panel">
        ...
        <div class="panel-header">
            ...
            <div id="fastMenu">
                ...
                <a href="#" class="DelFastMenu"><font color="gray">清除常用功能列表</font>
                </a>
            </div>
